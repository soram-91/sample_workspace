...
public class StringAPI {
	public static void main(String[] args) {
		...
		while (menuNo != 99) {
			...
			System.out.println("1. 단어 입력 2. 대,소문자 변환 3. 단어의 총 길이 4. 단어 자르기 5. 단어 자르기2 99.프로그램 종료");
			System.out.println("메뉴 선택");
			System.out.print(">");

			// -> nextLine = String + CR LF(엔터키)
			// -> Enter키 기준으로 인식
			// -> nextInt() => 5 + Enter (nextInt는 Enter키를 인식못함)
			...
			case 4:
				...
				System.out.println(word1.substring(Math.round(word1.length() / 2)));
				break;
			case 5:
